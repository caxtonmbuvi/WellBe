...
mixin _$JournalState {
  ...
  Result<JournalData> get journalResult => throw _privateConstructorUsedError;
...
abstract class $JournalStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({Result<JournalData> journalResult});

  $ResultCopyWith<JournalData, $Res> get journalResult;
}
...
class _$JournalStateCopyWithImpl<$Res, $Val extends JournalState>
  ...
  @override
  $Res call({
    Object? journalResult = null,
  }) {
    return _then(_value.copyWith(
      journalResult: null == journalResult
          ? _value.journalResult
          : journalResult // ignore: cast_nullable_to_non_nullable
              as Result<JournalData>,
    ) as $Val);
  }
  ...
  @pragma('vm:prefer-inline')
  $ResultCopyWith<JournalData, $Res> get journalResult {
    return $ResultCopyWith<JournalData, $Res>(_value.journalResult, (value) {
      return _then(_value.copyWith(journalResult: value) as $Val);
    });
  }
}
...
class _$JournalStateImpl implements _JournalState {
  const _$JournalStateImpl(
      {this.journalResult = const Result<JournalData>.empty()});

  /// Holds the current state of our journal data fetch
  @override
  @JsonKey()
  final Result<JournalData> journalResult;

  @override
  String toString() {
    return 'JournalState(journalResult: $journalResult)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.journalResult, journalResult) ||
                other.journalResult == journalResult));
  }

  @override
  int get hashCode => Object.hash(runtimeType, journalResult);
...
abstract class _JournalState implements JournalState {
  const factory _JournalState({final Result<JournalData> journalResult}) =
      _$JournalStateImpl;

  /// Holds the current state of our journal data fetch
  @override
  Result<JournalData> get journalResult;
